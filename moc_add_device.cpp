...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Add_Device_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Add_Device_t qt_meta_stringdata_Add_Device = {
    {
QT_MOC_LITERAL(0, 0, 10), // "Add_Device"
QT_MOC_LITERAL(1, 11, 9), // "addDevice"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "Add_Device\0addDevice\0"
};
...
const QMetaObject Add_Device::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Add_Device.data,
      qt_meta_data_Add_Device,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Add_Device::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Add_Device.stringdata0))
